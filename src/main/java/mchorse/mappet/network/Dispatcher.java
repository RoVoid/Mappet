...
import mchorse.mappet.network.client.content.ClientHandlerContentPaths;
import mchorse.mappet.network.client.ClientHandlerServerSettings;
import mchorse.mappet.network.client.ClientHandlerStates;
...
import mchorse.mappet.network.server.settings.ServerHandlerRequestServerSettings;
import mchorse.mappet.network.server.settings.ServerHandlerServerSettings;
import mchorse.mappet.network.server.states.ServerHandlerRequestStates;
import mchorse.mappet.network.server.states.ServerHandlerStates;
...
public class Dispatcher {
    ...
    public static void register() {
        ...
        /* Creative editing */
        push(PacketContentRequestPaths.class, ServerHandlerContentRequestPaths.class, Side.SERVER);
        ...
        push(PacketContentPaths.class, ClientHandlerContentPaths.class, Side.CLIENT);
        push(PacketContentExit.class, ServerHandlerContentExit.class, Side.SERVER);
        push(PacketContentRename.class, ServerHandlerContentRename.class, Side.SERVER);
