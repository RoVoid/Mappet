...
public class GuiUIConstructorPanel extends GuiMappetDashboardPanel<HUDScene>
{
    ...
    private UI current;
    private UIContext stage = new UIContext(current);

    public GuiUIConstructorPanel(Minecraft mc, GuiMappetDashboard dashboard)
    {
        super(mc, dashboard);

        this.list.setFileIcon(Icons.MAZE);
