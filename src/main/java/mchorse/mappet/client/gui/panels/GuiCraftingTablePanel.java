...
public class GuiCraftingTablePanel extends GuiMappetRunPanel<CraftingTable> {
    ...
    public GuiCraftingTablePanel(Minecraft mc, GuiMappetDashboard dashboard) {
        ...
        this.folderList.setFileIcon(Icons.WRENCH);
        ...
        this.recipes.sorting().context(() -> {
            GuiSimpleContextMenu menu = new GuiSimpleContextMenu(this.mc).action(Icons.ADD, IKey.lang("mappet.gui.crafting.context.add"),
                    this::addRecipe);
    ...
    @Override
    public IContentType<CraftingTable> getType() {
        return ContentTypes.CRAFT;
    }
